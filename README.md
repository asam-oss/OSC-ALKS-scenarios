...
2. a) Download the [latest esmini release](https://github.com/esmini/esmini/releases) (e.g. esmini-bin_win_x64.zip) (tested successfully with [esmini 2.12.2](https://github.com/esmini/esmini/releases/tag/v2.12.2)),  
or  
